...
public class SortTest
{
	...
	public void testAccuracy()
	{
		...
		testAccuracy(ITERATIONS, SIZE, new IntroSort1<>());
...
//	@Ignore
	...
	public void compareSpeeds()
	{
		...
		final int MAX_SIZE   = 2500;
		final int INCREMENT  = 100;
		final int OPS        = 1;
		final Random RAND    = new Random(0);
		
		SortSpeed comp = new SortSpeed();
		comp.printTotal(ITERATIONS, INIT_SIZE, MAX_SIZE, INCREMENT, OPS, RAND, new HeapSort<>(), new QuickSort<>(), new IntroSort1<>(), new IntroSort<>());
	}
